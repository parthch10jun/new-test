  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Neon accent colors - Using CSS variables for theme awareness
        neon: {
      ...
      boxShadow: {
        ...
        'neon-orange': '0 0 20px rgba(255, 107, 53, 0.3), 0 0 40px rgba(255, 107, 53, 0.1)',
        'neon-purple': '0 0 20px rgba(168, 85, 247, 0.3), 0 0 40px rgba(168, 85, 247, 0.1)',
        'glow-sm': '0 0 10px rgba(0, 245, 255, 0.2)',
        'glow-md': '0 0 20px rgba(0, 245, 255, 0.3)',
